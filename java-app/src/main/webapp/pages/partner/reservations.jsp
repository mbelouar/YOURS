...
function showSuccessMessage(message, type = 'success') {
    ...
    notificationDiv.className = 'notification-toast position-fixed';
    ...
    const titleText = type === 'success' ? 'Succès' : 'Action terminée';
    
    notificationDiv.innerHTML = 
        '<div style="display: flex; align-items: center; padding: 1rem; position: relative;">' +
            '<div style="position: absolute; left: 0; top: 0; bottom: 0; width: 3px; background: ' + colorScheme.borderLeft + ';"></div>' +
            '<div class="notification-icon" style="' +
                ...
                'box-shadow: 0 3px 12px ' + colorScheme.iconColor + '40;' +
            '">' +
                '<i class="fas ' + iconClass + '" style="color: white; font-size: 1rem;"></i>' +
            '</div>' +
            '<div class="notification-content" style="flex: 1;">' +
                '<h6 style="margin: 0 0 0.125rem 0; font-weight: 600; color: var(--gray-800); font-size: 0.9rem;">' +
                    titleText +
                '</h6>' +
                '<p style="margin: 0; color: var(--gray-600); font-size: 0.8rem; line-height: 1.3;">' +
                    message +
                '</p>' +
            '</div>' +
