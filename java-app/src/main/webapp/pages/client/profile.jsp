...
.enhanced-nav .profile-nav-list .profile-nav-item::before {
    content: '';
    position: absolute;
    top: 0;
    left: 0;
...
/* Special styling for the first active item to connect with header */
.enhanced-nav .profile-nav-list .profile-nav-item:first-child.active {
    border-radius: 0 0 0.75rem 0.75rem !important;
}
...
.enhanced-nav .profile-nav-item:hover .nav-icon-wrapper {
...
.enhanced-nav .profile-nav-item:hover .nav-icon-wrapper i {
    color: #1e40af;
}

.enhanced-nav .profile-nav-item.active .nav-icon-wrapper i {
    color: white;
}
...
.enhanced-nav .profile-nav-item:hover .nav-subtitle {
    opacity: 0.9;
}

.enhanced-nav .profile-nav-item.active .nav-subtitle {
    opacity: 0.8;
